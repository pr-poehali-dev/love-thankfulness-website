...
// 16 уникальных фото — каждое один раз, текст подобран по содержанию снимка
const ALL_PHOTOS = [
  {
  ...
  {
    // жемчужные серьги, широкая улыбка — улица
  ...
  {
    // золотые серьги, солнце сзади, серьёзная
  ...
  {
    // кольцо, смотрит в камеру, чёрный свитер
  ...
  {
    // вместе — он смотрит вниз, она смеётся громко
    ...
    color: "#FF1493", sym: "✿", rotate: "1deg", bear: BEAR2, bearPos: "left",
  },
  {
    // вместе, оба смотрят в камеру, v-знак, очки
  ...
  {
    // вместе, широкая улыбка — она сияет
  ...
  {
    // Лувр — золотые стены, смотрит вверх
    ...
    color: "#FFD700", sym: "◆", rotate: "-1.5deg", bear: BEAR1, bearPos: "right",
  },
  {
    // горы на фоне, еда, смотрит вниз
    ...
    color: "#00F5FF", sym: "●", rotate: "1deg", bear: BEAR2, bearPos: "left",
  },
  {
    // профиль на улице, солнце
    ...
    color: "#FF6B00", sym: "▲", rotate: "-1deg", bear: BEAR1, bearPos: "right",
  },
  {
    // кольцо, смотрит в камеру — другое фото
  ...
  {
    // Париж — Эйфелева башня, широкая улыбка
    ...
    message: "I truly believe that one day we will go to Paris together and fulfil our shared dreams. After Paris — the whole world. A million photos together. A million moments of happiness that belong only to us.",
    color: "#FFD700", sym: "★", rotate: "-1.5deg", bear: BEAR1, bearPos: "right",
  },
  {
    // жёлтые серьги, улыбается широко на улице
  ...
  {
    // Эйфелева башня — второе фото с башней
      ...
      <div className="fixed inset-0 pointer-events-none overflow-hidden z-0">
        {particles.map(p => (
          <span key={p.id} className="floating-particle select-none font-black absolute bottom-0"
            style={{ left: p.left, fontSize: p.size, animationDuration: `${p.duration}s`, animationDelay: `${p.delay}s`, color: p.color, textShadow: `0 0 10px ${p.color}` }}>
            {p.char}
          </span>
        ))}
      </div>
      ...
      <div className="relative z-10 max-w-xl mx-auto px-5 pt-16 pb-20">
          ...
          {ALL_PHOTOS.map((p, i) => (
            <FadeIn key={i}>
              <div className="relative">
                <div className={`absolute ${p.bearPos === "right" ? "-right-6 md:-right-14" : "-left-6 md:-left-14"} top-8 pointer-events-none`} style={{ zIndex: 0 }}>
                ...
                <div className="flex items-center gap-3 mb-5 relative z-10">
                  ...
                  <span className="text-xs font-black tracking-widest" style={{ color: p.color, fontFamily: "Bebas Neue, sans-serif" }}>
                ...
                <h2 className="font-black mb-3 relative z-10"
                  style={{ fontFamily: "Bebas Neue, sans-serif", fontSize: "clamp(1.6rem, 5.5vw, 2.4rem)", color: p.color, textShadow: `0 0 20px ${p.color}50`, letterSpacing: "0.03em" }}>
                  {p.title}
                </h2>
                ...
                <div className="mt-5 h-px relative z-10" style={{ background: `linear-gradient(90deg, ${p.color}70, transparent)` }} />
              </div>
            </FadeIn>
          ))}
        </div>
        ...
        <FadeIn className="mt-24">
          <div className="relative rounded-2xl p-8 md:p-12 text-center overflow-hidden"
            style={{ background: "rgba(45,10,78,0.75)", border: "1.5px solid rgba(255,0,144,0.45)", boxShadow: "0 0 70px rgba(255,0,144,0.18)" }}>
            ...
            <div className="relative z-10 space-y-6">
              ...
              <p className="text-base md:text-lg leading-relaxed text-purple-100 max-w-md mx-auto" style={{ fontFamily: "sans-serif" }}>
        ...
        <div className="text-center mt-14">
          <p className="font-black gradient-magenta text-xl tracking-widest" style={{ fontFamily: "Bebas Neue, sans-serif" }}>
            FOR PRINCESS JASMINE ★
          </p>
          <p className="text-purple-600 text-xs mt-1 tracking-widest" style={{ fontFamily: "Bebas Neue, sans-serif" }}>2026</p>
        </div>
